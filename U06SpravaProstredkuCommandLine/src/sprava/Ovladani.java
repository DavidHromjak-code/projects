 ...
 * @param <E>
 */
public interface Ovladani<E extends Klon> extends Iterable<E> {
...
// ----- konfigurace -----------------------------------------------------------   
     ...
     */
    void vytvorSeznam(Supplier<Seznam<E>> supplier);
 ...
 vytvoření seznamu na poli.<p>
     ...
     */
    void vytvorSeznam(Function<Integer, Seznam<E>> funtion, int size)
...
// ----- přístup a změny  prostredků v seznamu ---------------------------------
     ...
     * parametru data
     */
    void vlozPolozku(E data) throws NullPointerException;

    /**
     * Metoda vrátí referenci na vyhledanou datovou položku v seznamu podle
     * hodnoty klíče. Hodnotu určuje implementace komparátoru .
     * <p>
     * Příklad použití:
     * <pre>{@code
     *    Ovladani<DopravniProstredek> spravce = new SpravaProstredku();
...
// ----- pohyb po seznamu, nastavení aktuálního prostředku ---------------------    
     ...
     * @return 
     */
    E nastavAktualniPolozku(E klic);
 ...
 <p>
     ...
     */
    void editujAktualniPolozku(Function<E, E> editor);
